...
DENIS VERSION
--------
Removed, local features to create a network version.
It will launch relations between cloud elements.

It works over MQTT with topics to get user text and to return some answer.

Versions:

## Heroku

Get online version from:
https://git.heroku.com/denisbot.git
...
- ### node-red (For iot.eclipse.org, 1883)
     ...
     Test on http://plaza-aleph.tk
     https://denisbot.herokuapp.com/

Listens at: PLAZA_ALEPH/DENIS
